...
var projects = new Array(
    ...
    <p  style = "font-size: 1.85vh;">
        ...
        <br><br>
        <strong>Technical Details</strong><br>Uses a Microservices Serverless Architecture on GCP using NodeJs. API's run in Docker and Kubernetes, with a scalable NoSQL database.
        </p>
    `,
    `
